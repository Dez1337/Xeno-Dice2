...
------------------------------------------------------------------------------------------------------------------
	...
	_Containers_Items = "Fur Backpack"									-- Container for items
	...
	_Inactivity_MessageBlockedSpot = "Anti idle = Activated."
...
------------------------------------------------------------------------------------------------------------------
	...
	_Effects_Interval = 2													-- How often to show effects | Default: 1 second | WARNING: Low values may affect performance
	
	-- Remote Status --
	_Remote_Status = false														-- Enable the use of remote commands to know the status of the gambling session
	_Remote_AdminName = { "Zurek Grecki", "name2" }									-- Name of the character used to request status information
	...
	_Remote_BackupCrystalCoins = 10											-- Amount of crystal coins to leave inside the depot
	...
	-- Extra Settings --
	_Extra_CipStaffDetection = false												-- Stop script when a Cipsoft member is detected
	_Extra_AlarmLowCash = false													-- Stop script and play alarm when cash is not enough to gamble
	...
	_Extra_WorkloadExecution = 'medium'										-- The speed to execute actions (default/fast/medium/slow)
...
------------------------------------------------------------------------------------------------------------------
	...
	Blackjack = true
	Blackjack_Minimum = 30000
	Blackjack_Maximum = 300000
	Blackjack_Payout = 80
	
	-- High/Low = 123 or 456 --
	High_Low = true
	High_Low_Minimum = 30000
	High_Low_Maximum = 300000
	High_Low_Payout = 80
	
	-- Odd/Even = 135 or 246 --
	Odd_Even = true
	Odd_Even_Minimum = 30000
	Odd_Even_Maximum = 300000
	Odd_Even_Payout = 80
	...
	Highest_Lowest_Minimum = 30000
	Highest_Lowest_Maximum = 300000
	Highest_Lowest_Payout = 80
	
	-- First/Second/Last = 12, 34 or 56 --
	First_Second_Last = true
	First_Second_Last_Minimum = 30000
...
------------------------------------------------------------------------------------------------------------------
	...
	_Interaction_PrivateMessages = false											-- Send interactive messages through PM instead of Local Chat
	Invalid_Bid =
	{
		-- [game], [min], [max]
	...
	{
		-- Placeholder: [player]
		"Welcome, [player]! Do you want to try your luck? Best Payrate! 30k - 300k",
		"Hello, [player]! ask me about my 'games' or 'rates' Also accepting Items!",
		"Hello, [player]! Are you curious about my games? Say 'games' or 'rates' Accepting items! Trade in your loot for gold!",
		"Hi, [player]! Welcome to the most trusted casino in town! 30k - 300k stakes, accepting items!",
	}	
...
------------------------------------------------------------------------------------------------------------------
	...
	_Broadcast_Interval = 30														-- Time in seconds to wait before the next broadcast
	_Broadcast_FixedInterval = true												-- Broadcast even with players around or when gambling | WARNING: May affect performance
	...
	_Broadcast_Messages =
	{
		"[name]'s Casino - Most trusted automated casino since day one! Trade in your loot here!",
		"Become a millionaire at [name]'s Casino! 30k - 300k stakes! Accepting items!",
		"Come and play the fastest game at the best casino in town!",
		"Feeling lucky? The best payrate in all Tibia! Try it out. Trade in your loot for pure gold!",
		"Don't trust rigged casino's. Only at [name]'s casino the games are 100% fair!",
	}
...
------------------------------------------------------------------------------------------------------------------
	...
	Accept_Items = true															-- Accept items as bets
	Items_List =
	{
		-- Products --
